...
% Project Title: A hybrid algorithm combining the multi-objective artificial %bee colony and differential evolution

% Developer: wathiq dukhan
% 
% Contact Info: dralwathiq2012@gmail.com
%
function [NDS,HV,DeltaSpread] = HABCDE
clear;
...
%% A hybrid algorithm combining the multi-objective artificial bee colony %and differential evolution
F1=[];
for it=1:MaxIt

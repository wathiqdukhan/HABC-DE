...
MaxIt = 30;     %50 Maximum Number of Iterations
nPop  = 500;      %300 Population Size
TERMLIM = -1;% -1; % if you want to filter the duplicate make this 0
DSTLIM = 1; % 1 if you want to have more solutios in the middle of the graph, increase this value, say 4
pCrossover = 0.80 ;%0.80;
pMutation =0.5 ;%0.5;
mu =0.01; %0.01;
...
for i = 1: runs
    ...
    tic
    [NDS(i),HV(i),DeltaSpread(i)] = HABCDE;
    sec = toc;
